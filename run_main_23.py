...
#     ENV_task = ENV_BR_HER2
    ...
    if 23 in task_ids:
        exist_model_name = 'checkpoint_GatedAttPool-PTAGT_dx{}_{}-2022-05-28.pth'.format(ENV_task.FOLD_SUFFIX, ENV_task.TASK_NAME)
        _run_train_gated_attpool_resnet18(ENV_task, exist_model_name)
